...
The next step is to diagnose shared-fit interference, including task scaling, weighting, regularization, and calibration coverage. Residual transfer loss cannot yet be attributed to intrinsic concept mismatch.
