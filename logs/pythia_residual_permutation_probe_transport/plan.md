...
**H1 — Function preservation.** In deterministic FP32, the transformation must produce maximum absolute logit error at most $10^{-3}$, 100% next-token agreement, and relative activation-equivariance error at most $10^{-4}$ at every probed layer. Failure of either gate invalidates the intervention.
