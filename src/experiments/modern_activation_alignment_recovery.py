...
def _validate_config(config: dict[str, Any]) -> None:
    ...
    if models != ["llama", "qwen", "nemotron"] or config["data_seeds"] != [42, 137]:
        raise ValueError(
            "The modern alignment study requires Llama, Qwen, Nemotron, and two seeds."
        )
    ...
    if evaluation.get("pair_groups") != expected_groups:
